...
If using Docker Compose, enable the optional `strategy_state` service (profile `shared_state`) and set `STRATEGY_STATE_HOST` to the service host or `127.0.0.1` when using host networking.
